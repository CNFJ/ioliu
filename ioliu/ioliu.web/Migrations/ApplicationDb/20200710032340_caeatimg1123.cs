...
namespace ioliu.web.Migrations.ApplicationDb
{
    public partial class caeatimg1123 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Education_AspNetUsers_SystemUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemUserId1 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Work", x => x.id);
                    table.ForeignKey(
                        name: "FK_Work_AspNetUsers_SystemUserId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Education_SystemUserId",
                table: "Education",
                column: "SystemUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Work_SystemUserId1",
                table: "Work",
